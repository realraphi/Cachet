...
return [
    ...
    'incident' => [
        ...
        'update' => [
            ...
            'sms' => [
                'content' => 'Eintrag :name wurde aktualisiert',
            ],
        ],
    ],
    'schedule' => [
    ...
    'subscriber' => [
        ...
        'manage' => [
            'mail' => [
                'subject' => 'Abonnement verwalten',
                'content' => 'Hier klicken, um das Abonnement von :app_name zu verwalten.',
                'title'   => 'Hier klicken, um das Abonnement von :app_name zu verwalten.',
